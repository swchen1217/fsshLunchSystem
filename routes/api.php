...
Route::group([
    ...
    Route::get('/total/{date1}/{date2}', 'BalanceController@getTotal')->middleware(['permission2:balance.read']);
...
Route::group([
    ...
    Route::get('/total/{date1}/{date2}', 'OrderController@getTotal')->middleware(['permission2:order.read']);
